...
<script lang="ts">
  ...
  import vertexShader from "$lib/shaders/raging_sea/vertex.glsl";
  import fragmentShader from "$lib/shaders/raging_sea/fragment.glsl";
  ...
  function start() {
    ...
    const planGeometry = new THREE.PlaneGeometry(2, 2, 512, 512);
